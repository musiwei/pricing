...
/**
 * @see Application_Global_Controller_Plugin_Debug_Plugin_Text
 */
require_once 'Application/Global/Controller/Plugin/Debug/Plugin/Text.php';
 ...
 * @license    http://code.google.com/p/zfdebug/wiki/License     New BSD License
 */
class Application_Global_Controller_Plugin_Debug extends Zend_Controller_Plugin_Abstract
{
    /**
    ...
    public function __construct($options = null)
    {
         ...
         */
        $version = new Application_Global_Controller_Plugin_Debug_Plugin_Text();
     ...
     *
     * @param array $options
     * @return Application_Global_Controller_Plugin_Debug
     */
     ...
     *
     * @param Application_Global_Controller_Plugin_Debug_Plugin_Interface
     * @return Application_Global_Controller_Plugin_Debug
     */
    public function registerPlugin(Application_Global_Controller_Plugin_Debug_Plugin_Interface $plugin)
    {
     ...
     * @return Application_Global_Controller_Plugin_Debug_Plugin_Interface
     */
    ...
    public function dispatchLoopShutdown()
    {
        ...
        foreach ($this->_plugins as $plugin)
        {
            ...
            /* @var $plugin Application_Global_Controller_Plugin_Debug_Plugin_Interface */
    ...
    protected function _loadPlugins()
    {
    	foreach($this->_options['plugins'] as $plugin => $options) {
    	    ...
    	    if (is_object($plugin) && in_array('Application_Global_Controller_Plugin_Debug_Plugin_Interface', class_implements($plugin))) {
    	    ...
    	    if (in_array($plugin, Application_Global_Controller_Plugin_Debug::$standardPlugins)) {
    	        // standard plugin
                $pluginClass = 'Application_Global_Controller_Plugin_Debug_Plugin_' . $plugin;
    	    } else {
    ...
    protected function _headerOutput() {
        ...
        return ('
            ...
            <script type="text/javascript">
                /* Commented By Siwei 15 Mar 2014
